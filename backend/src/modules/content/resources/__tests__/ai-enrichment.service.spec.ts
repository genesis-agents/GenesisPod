...
describe('AIEnrichmentService', () => {
  ...
  describe('classifyContent', () => {
    ...
    it('should return null on error', async () => {
      mockAxiosInstance.post.mockRejectedValue(new Error('Classification failed'));
  ...
  describe('enrichResourceWithStructured', () => {
    ...
    it('should enrich resource with structured summary', async () => {
      ...
      mockAxiosInstance.post
        ...
        .mockResolvedValueOnce({
          data: { category: 'Blog', tags: ['tech'], difficulty_level: 'intermediate' },
        })
        .mockResolvedValueOnce({
    ...
    it('should use fallback if structured summary fails', async () => {
      mockAxiosInstance.post
        ...
        .mockResolvedValueOnce({
          data: { category: 'Technology', tags: [], difficulty_level: 'beginner' },
        })
