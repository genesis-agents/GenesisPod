...
describe("TableManagementController", () => {
  ...
  let service: jest.Mocked<TableManagementService>;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        {
          provide: TableManagementService,
          useValue: {
    ...
    controller = module.get<TableManagementController>(
      TableManagementController,
    );
    service = module.get(TableManagementService);
  });
