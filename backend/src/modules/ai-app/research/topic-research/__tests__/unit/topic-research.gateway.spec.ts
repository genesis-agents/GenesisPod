// @ts-nocheck
/**
 * TopicResearchGateway Unit Tests
 *
...
describe("TopicResearchGateway", () => {
  let gateway: TopicResearchGateway;
  ...
  beforeEach(async () => {
    ...
    gateway = module.get<TopicResearchGateway>(TopicResearchGateway);
    // Inject mock server
