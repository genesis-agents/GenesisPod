...
/**
 * DeepDive Engine 项目知识库标题
 */
export const PROJECT_KNOWLEDGE_SECTION_TITLE = `## DeepDive Engine 项目知识库`;

/**
 * DeepDive Engine 项目知识库引导语
 */
export const PROJECT_KNOWLEDGE_INTRO = `以下是 DeepDive Engine 项目的内置知识，请基于这些信息回答关于本项目的问题：`;
