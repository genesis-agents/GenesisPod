...
export class WritingMissionLifecycleService {
  ...
  constructor(
    ...
    // Role/team registration is handled by WritingMissionService (god service).
    // Once the god service is fully removed, this service will take ownership.
  }
  ...
  // Role/team registration methods removed - handled by WritingMissionService (god service)
  // during migration period. Will be restored here when god service is fully removed.
}
