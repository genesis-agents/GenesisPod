...
export class ConstraintEnforcementService {
  ...
  /**
   * 从 MissionContextPackage 获取 MUST 约束
   */
  getMustConstraints(contextPackage: MissionContextPackage): HardConstraint[] {
    return contextPackage.hardConstraints.filter((c) => c.severity === "MUST");
  }
