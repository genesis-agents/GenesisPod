...
describe('ReadingExperienceService', () => {
  ...
  describe('analyzeAndOptimize', () => {
    ...
    it('should return 100 score for empty sections', () => {
      const result = service.analyzeAndOptimize([], buildMockDocumentFeatures());
    ...
    it('should calculate estimated reading time per section', () => {
      ...
      expect(result.optimizedSections[0].estimatedReadingTime).toBeGreaterThan(0);
    });
    ...
    it('should use different configuration for HIGH complexity', () => {
      ...
      const result = service.analyzeAndOptimize(sections, highComplexityFeatures);
    ...
    it('should use different configuration for LOW complexity', () => {
      ...
      const result = service.analyzeAndOptimize(sections, lowComplexityFeatures);
  ...
  describe('quickAssess', () => {
    ...
    it('should NOT penalize for headings when using # format', () => {
      const textWithHeadings = '# Heading\n\nParagraph 1.\n\n## Sub\n\nParagraph 2.\n\n### Sub2\n\nMore\n\n#### More\n\nEven more\n\n##### Level5\n\nAnd more\n\n###### Level6\n\nLast';
    ...
    it('should score 0 or above at minimum (no negative scores)', () => {
      const terribleText = 'A'.repeat(300) + '\n\n' + 'B'.repeat(300) + '\n\n' + 'C'.repeat(300) + '\n\n' + 'D'.repeat(3500);
