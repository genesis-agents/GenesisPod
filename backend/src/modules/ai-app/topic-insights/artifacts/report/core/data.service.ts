...
import { stripChartJsonFromContent } from "@/modules/ai-app/topic-insights/shared/utils/strip-chart-json.utils";
import { resolveChartPlaceholders } from "@/modules/ai-app/topic-insights/shared/utils/chart-placeholder.utils";
import type {
  TopicReport,
  DimensionAnalysis,
  TopicEvidence,
...
export class ReportDataService {
  ...
  async saveDimensionAnalysis(
    ...
    result: {
      ...
      modelUsed?: string;
      remediationTraces?: import("@/modules/ai-app/topic-insights/shared/types/quality.types").RemediationTrace[];
    },
