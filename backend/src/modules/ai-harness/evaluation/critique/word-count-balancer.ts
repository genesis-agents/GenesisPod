 ...
 *
 * 沉淀自：ai-app/<consumer>/services/core/leader/leader-planning.service.ts:859-880
 * 移植落地：ai-app/<consumer>/services/.../helpers/word-count-normalizer.util.ts (Phase 1)
 *
