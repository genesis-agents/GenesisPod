...
export const TOOL_ID_CLASS_MAP: Record<string, Type<ITool>> = {
  ...
  "ontology-upsert-object": OntologyUpsertObjectTool,
  "ontology-add-link": OntologyAddLinkTool,
  "ontology-set-confidence": OntologySetConfidenceTool,
  "ontology-edit-property": OntologyEditPropertyTool,
  "ontology-merge-objects": OntologyMergeObjectsTool,
