...
import { IRole, WorkStyle } from "../../teams/abstractions/role.interface";
import { SkillId, ToolId } from "../../core/types/agent.types";
import { A2AAgentCard, A2ATaskStatus } from "../abstractions/a2a.interface";
