...
describe("AiObservabilityService", () => {
  ...
  describe("getDashboard()", () => {
    ...
    it("should calculate success rate", () => {
      ...
      service.recordLLMCall(createEvent({ success: true }));
      service.recordLLMCall(createEvent({ success: false, error: "timeout" }));
  ...
  describe("getLatencyPercentiles()", () => {
    ...
    it("should filter by model when specified", () => {
      service.recordLLMCall(createEvent({ model: "gpt-4o", latencyMs: 200 }));
      service.recordLLMCall(
  ...
  describe("getRecentErrors()", () => {
    ...
    it("should return failed events in reverse chronological order", () => {
      service.recordLLMCall(createEvent({ success: false, error: "error-1" }));
      service.recordLLMCall(createEvent({ success: false, error: "error-2" }));
