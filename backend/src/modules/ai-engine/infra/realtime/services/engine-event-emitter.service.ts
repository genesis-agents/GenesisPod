 ...
 */
@Injectable()
export class EngineEventEmitterService implements IEngineEventEmitter {
  private readonly logger = new Logger(EngineEventEmitterService.name);
