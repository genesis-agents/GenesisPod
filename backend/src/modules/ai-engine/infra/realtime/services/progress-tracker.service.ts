...
} from "../abstractions/progress-tracker.interface";
import type { ProgressEvent } from "../abstractions/event-emitter.interface";
...
export class ProgressTrackerService implements IProgressTracker {
  ...
  constructor(private readonly eventEmitter: EngineEventEmitterService) {}
