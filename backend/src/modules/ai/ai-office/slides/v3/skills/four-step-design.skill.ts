...
#### 数据页 (dashboard/kpi) ⭐ 必须有实际数据！
布局：**左侧 40% 数据卡片 + 右侧 60% 列表/图表**

**⚠️ 每个数据卡片必须包含真实数字和标签！禁止空白！**
...
<div style="display: flex; gap: 32px; height: calc(100% - 100px);">
  <div style="flex: 0 0 38%; display: flex; flex-direction: column; gap: 16px;">
    ...
    <div style="flex: 1; background: rgba(30, 41, 59, 0.8); border: 1px solid #334155; border-radius: 12px; padding: 20px;">
      <div style="font-size: 14px; color: #94A3B8; margin-bottom: 8px;">【指标名称】</div>
      <div style="font-size: 48px; font-weight: 900; color: #D4AF37;">【实际数字如 85%】</div>
      <div style="font-size: 14px; color: #94A3B8; margin-top: 8px;">【补充说明】</div>
    </div>
    <!-- 数据卡片 2 -->
    <div style="flex: 1; background: rgba(30, 41, 59, 0.8); border: 1px solid #334155; border-radius: 12px; padding: 20px;">
      <div style="font-size: 14px; color: #94A3B8; margin-bottom: 8px;">【指标名称】</div>
      <div style="font-size: 48px; font-weight: 900; color: #3B82F6;">【实际数字】</div>
      <div style="font-size: 14px; color: #94A3B8; margin-top: 8px;">【补充说明】</div>
    </div>
  </div>
  <div style="flex: 1; background: rgba(30, 41, 59, 0.6); border: 1px solid #334155; border-radius: 12px; padding: 24px;">
    <!-- 右侧列表/图表区，至少 4-6 个列表项 -->
  </div>
</div>
\`\`\`

#### 时间线页 (timeline/evolutionRoadmap) ⭐ 必须有阶段内容！
布局：**横向流程 + 下方详情**

**⚠️ 每个阶段必须有标题、时间、描述！禁止空白节点！**
...
<div style="display: flex; flex-direction: column; height: calc(100% - 100px);">
  ...
  <div style="position: relative; padding: 40px 0;">
    ...
    <div style="display: flex; justify-content: space-between; position: relative;">
      <div style="text-align: center;">
        ...
        <div style="font-size: 14px; font-weight: 700; color: #D4AF37;">【阶段1】</div>
        <div style="font-size: 12px; color: #94A3B8;">【时间】</div>
      </div>
      <!-- 重复 3-4 个节点 -->
    </div>
  </div>
  ...
  <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; flex: 1;">
    <div style="background: rgba(30, 41, 59, 0.8); border-radius: 12px; padding: 16px; border-top: 3px solid #D4AF37;">
      <h4 style="font-size: 16px; font-weight: 700; margin: 0 0 8px 0; color: #D4AF37;">【阶段标题】</h4>
      <p style="font-size: 13px; color: #94A3B8; margin: 0;">【阶段描述内容】</p>
    </div>
    <!-- 重复 3-4 个卡片 -->
  </div>
</div>
...
#### 风险机遇页 (riskOpportunity) ⭐ 必须有风险和机遇内容！
布局：**左右双列对比**

**⚠️ 必须从 pageContent.sections 获取风险和机遇的实际内容！**
    ...
    <div style="display: flex; flex-direction: column; gap: 12px; flex: 1;">
      ...
      <div style="background: rgba(30, 41, 59, 0.8); border-left: 3px solid #EF4444; border-radius: 8px; padding: 16px;">
        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
          ...
          <div style="font-size: 15px; font-weight: 600;">【风险标题】</div>
        </div>
        <p style="font-size: 13px; color: #94A3B8; margin: 0;">【风险描述】</p>
      </div>
      <!-- 重复 2-3 个风险项 -->
    </div>
  </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 12px; flex: 1;">
      ...
      <div style="background: rgba(30, 41, 59, 0.8); border-left: 3px solid #10B981; border-radius: 8px; padding: 16px;">
        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
          ...
          <div style="font-size: 15px; font-weight: 600;">【机遇标题】</div>
        </div>
        <p style="font-size: 13px; color: #94A3B8; margin: 0;">【机遇描述】</p>
      </div>
      <!-- 重复 2-3 个机遇项 -->
    </div>
  </div>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 32px; height: calc(100% - 100px);">
  <div style="background: rgba(30, 41, 59, 0.8); border-radius: 12px; padding: 24px; display: flex; flex-direction: column;">
    <h3 style="font-size: 18px; font-weight: 700; margin: 0 0 16px 0; color: #D4AF37;">【对比项A标题】</h3>
    <!-- 4-6 个要点 -->
  </div>
  <div style="background: rgba(30, 41, 59, 0.8); border-radius: 12px; padding: 24px; display: flex; flex-direction: column;">
    <h3 style="font-size: 18px; font-weight: 700; margin: 0 0 16px 0; color: #3B82F6;">【对比项B标题】</h3>
    <!-- 4-6 个要点 -->
  </div>
</div>
\`\`\`
...
#### 支柱页 (pillars) ⭐ 重要 - 绝对不能空白！
布局：**等宽多列卡片，填满整个内容区**

**⚠️ 关键：必须从 pageContent.sections 提取实际内容填入每个支柱卡片！**

\`\`\`html
<div style="display: flex; gap: 24px; height: calc(100% - 100px);">
  <!-- 支柱 1：从 sections[0] 获取内容 -->
  <div style="flex: 1; background: rgba(30, 41, 59, 0.8); border-radius: 12px; padding: 24px; display: flex; flex-direction: column; border-top: 4px solid #D4AF37;">
    ...
    <h3 style="font-size: 20px; font-weight: 700; margin: 0 0 12px 0; color: #D4AF37;">【必须填写实际标题】</h3>
    <p style="font-size: 14px; color: #94A3B8; margin: 0 0 16px 0; flex: 1; line-height: 1.6;">【必须填写至少3-4行实际描述内容，从 pageContent.sections 获取】</p>
    <div style="padding-top: 16px; border-top: 1px solid #334155;">
      <div style="font-size: 28px; font-weight: 900; color: #D4AF37;">【实际数字】</div>
      <div style="font-size: 12px; color: #64748B;">【数据标签】</div>
    </div>
  </div>
  <!-- 支柱 2：从 sections[1] 获取内容，颜色用 #3B82F6 -->
  <!-- 支柱 3：从 sections[2] 获取内容，颜色用 #10B981 -->
</div>
\`\`\`
**关键要求**：
- **必须使用 height: calc(100% - 100px)**：确保内容填满整个可用高度
- 每个卡片使用 **flex: 1** 等分宽度
- **⭐ 每个卡片必须有实际内容**：从 pageContent.sections 获取标题、描述、数据
- 描述文字使用 **flex: 1** 填充中间空间
- **禁止留空或使用占位符！**
...
\`\`\`html
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 32px; height: calc(100% - 100px);">
  <div style="background: rgba(30, 41, 59, 0.8); border-radius: 12px; padding: 28px; display: flex; flex-direction: column;">
    <h3 style="font-size: 22px; font-weight: 700; margin: 0 0 20px 0; color: #D4AF37;">列标题</h3>
...
<div style="display: flex; flex-direction: column; height: calc(100% - 100px);">
  <!-- 顶部说明 -->
  <div style="text-align: center; margin-bottom: 24px;">简要说明</div>
  <!-- 核心框架区 -->
  <div style="flex: 1; display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
    <!-- 框架元素 -->
  </div>
  <!-- 底部说明 -->
  <div style="margin-top: 24px; text-align: center;">总结</div>
</div>
\`\`\`
...
<div style="display: flex; flex-direction: column; gap: 16px; height: calc(100% - 100px);">
  ...
  <div style="flex: 1; background: rgba(30, 41, 59, 0.6); border-radius: 12px; padding: 20px; display: flex; align-items: center; gap: 20px;">
    ...
    <div style="flex: 1;">
      <h4 style="font-size: 18px; font-weight: 600; margin: 0 0 8px 0;">推荐标题</h4>
      <p style="font-size: 14px; color: #94A3B8; margin: 0;">详细描述...</p>
    </div>
  </div>
</div>
\`\`\`
