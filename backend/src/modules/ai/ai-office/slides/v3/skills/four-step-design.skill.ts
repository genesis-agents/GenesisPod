...
<div style="display: flex; gap: 24px; height: calc(100% - 100px);">
  ...
  <div style="flex: 1; background: rgba(30, 41, 59, 0.8); border-radius: 12px; padding: 24px; display: flex; flex-direction: column; border-top: 4px solid #D4AF37;">
    <div style="width: 48px; height: 48px; background: rgba(212, 175, 55, 0.15); border-radius: 12px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;">
      <i class="fas fa-icon" style="color: #D4AF37; font-size: 20px;"></i>
    </div>
    <h3 style="font-size: 20px; font-weight: 700; margin: 0 0 12px 0; color: #D4AF37;">支柱标题</h3>
    <p style="font-size: 14px; color: #94A3B8; margin: 0 0 16px 0; flex: 1;">详细描述内容，至少3-4行文字...</p>
    <div style="padding-top: 16px; border-top: 1px solid #334155;">
      <div style="font-size: 28px; font-weight: 900; color: #D4AF37;">85%</div>
      <div style="font-size: 12px; color: #64748B;">数据标签</div>
    </div>
  </div>
  <!-- 重复 2-4 个类似卡片，颜色交替使用 #D4AF37, #3B82F6, #10B981, #8B5CF6 -->
</div>
\`\`\`
**关键要求**：
- **必须使用 height: calc(100% - 100px)**：确保内容填满整个可用高度
- 每个卡片使用 **flex: 1** 等分宽度
- 每个卡片必须有：图标 + 标题 + 描述 + 底部数据
