...
import { AiSimulationService } from "../../../ai-simulation/ai-simulation.service";
import { AiSimulationEngineService } from "../../../ai-simulation/ai-simulation.engine";
...
export class SimulatorAgent extends BaseAgent {
  ...
  readonly type = AgentType.SIMULATOR;
