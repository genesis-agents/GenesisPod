...
import { ShortTermMemoryService } from "../../core/memory/short-term.memory";
...
> {
  readonly type = ToolType.SHORT_TERM_MEMORY;
  readonly name = "短期记忆";
  ...
  validateInput(input: ShortTermMemoryInput): boolean {
    // 验证操作类型
  ...
  protected async doExecute(
    ...
    const sessionId = input.sessionId ?? context.taskId;
