...
import { EXTERNAL_TOOL_SECRET_MAPPING } from "../../../platform/credentials/secrets/secret-name.catalog";
import { EXTERNAL_TOOL_DEFINITIONS } from "../../../platform/credentials/secrets/external-tool-definitions";
