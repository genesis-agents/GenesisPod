...
export function WechatWorkBindingCard() {
  ...
  const fetchStatus = useCallback(async () => {
    try {
      ...
      console.error('Failed to fetch WeChat Work binding status:', err);
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const handleBind = async () => {
    ...
    try {
      ...
      console.error('Failed to bind WeChat Work ID:', err);
  ...
  const handleUnbind = async () => {
    ...
    try {
      ...
      console.error('Failed to unbind WeChat Work ID:', err);
