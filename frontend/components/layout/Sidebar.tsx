    ...
    >
      ...
      <nav className="flex-1 px-3 py-2">
        <div className="space-y-1">
          ...
          {/* AI Office 子菜单 - AI Slides */}
          {showExpanded && (
            <Link
              href="/ai-office/slides"
              className={`ml-6 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium ${
                pathname?.includes('/ai-office/slides')
            ...
            >
              ...
              >
                ...
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M9 9h1.5a1.5 1.5 0 110 3H9v3m0-6v6"
                />
              </svg>
              <span>AI Slides</span>
            </Link>
          ...
          {/* AI Office 子菜单 - AI Docs */}
          {showExpanded && (
            <Link
              href="/ai-office/docs"
              className={`ml-6 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium ${
                pathname?.includes('/ai-office/docs')
          ...
          {/* AI Office 子菜单 - AI Designer */}
          {showExpanded && (
            <Link
              href="/ai-office/designer"
              className={`ml-6 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium ${
                pathname?.includes('/ai-office/designer')
