/**
 * Topic Insights Store - Modular Architecture
 *
...
interface TopicInsightsState extends TopicSlice, ReportSlice, ResearchSlice {
  // UI Actions
  resetStore: () => void;
  resetTopicData: () => void;
}

export const useTopicInsightsStore = create<TopicInsightsState>()((
  set,
  get,
  api
) => {
