...
**积分系统（Credits System）** 是 DeepDive Engine 的核心计费和资源管控机制，通过虚拟积分实现对 AI 功能使用的量化管理，确保平台资源的合理分配和可持续运营。

### 1.2 核心问题

DeepDive Engine 提供多种 AI 功能模块，每个模块的 AI 调用成本差异显著：
