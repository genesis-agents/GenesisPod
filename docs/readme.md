...
| [自动化开发闭环](guides/automated-development-loop.md) | TDD工作流、自动验证、Hooks配置 | 所有开发者       |
...
| 文档                                                 | 说明                    | 状态        |
| ---------------------------------------------------- | ----------------------- | ----------- |
| [功能概览](features/ai-coding/ai-coding-overview.md) | 多Agent协作代码生成平台 | 📋 技术文档 |
| [WebSocket API](features/ai-coding/websocket-api.md) | 实时进度推送接口        | 📖 API文档  |
| [Kanban功能](features/ai-coding/kanban-feature.md)   | 看板式项目管理          | 🎨 功能设计 |

#### AI Group 多AI协作

| 文档                                                              | 说明                         | 状态        |
| ----------------------------------------------------------------- | ---------------------------- | ----------- |
| [AI Group PRD v1.0](prd/ai-group-prd-v1.0.md)                     | 多人多AI协作社区产品需求     | 📋 产品规格 |
| [AI Group 交互规范 v2.0](prd/ai-group-spec-v2.0.md)               | AI交互核心功能规格           | 📋 功能规格 |
| [AI Agent 团队协作 v1.0](prd/ai-group-team-collaboration-v1.0.md) | Leader驱动的团队协作功能方案 | 📋 产品规格 |
