...
This document defines the standard workflow for database migrations in DeepDive Engine. All team members must follow these guidelines to ensure database stability and consistency.
