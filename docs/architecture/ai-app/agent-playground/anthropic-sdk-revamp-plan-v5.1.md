...
|           | A.7 s5-reconciler hook                                            | ⏳ in progress | —                       | synthesize primitive synthesize hook       |
...
- 设 `PLAYGROUND_RUNTIME=pipeline-v1` 或加白名单 → 走新轨，**目前会在 s5-reconciler 处 NotYetWired fail**（s1-s4 已通）
- 主干现有 30+ 个 R0.5/R1/R3-A/R2-A0/R2-A.0~A.6 commit **可安全 push**，对线上无影响
