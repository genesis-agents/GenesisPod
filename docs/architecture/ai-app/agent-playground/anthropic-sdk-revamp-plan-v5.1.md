...
|           | E-W1-a tool-augment 域：tool-timeout + tool-validation-zod 迁出+激活 | ✅             | (this PR)               | legacy timeout/validation middleware 删；HookBus 注入 ToolPipeline；AppModule.forRoot 注册 |
|           | E 剩余 20 plugin 批量迁出                                            | ⏳ pending     | —                       | W1-b/W1-c/W2-W6 排期未定                                                                   |
