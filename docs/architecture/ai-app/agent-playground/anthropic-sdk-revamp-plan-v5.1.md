...
|           | A.11 s8b/s9/s9b hook (review×3)                                   | ⏳ in progress | —                       | review primitive review hook ×3            |
...
- 设 `PLAYGROUND_RUNTIME=pipeline-v1` 或加白名单 → 走新轨，**目前会在 s8b-quality-enhancement 处 NotYetWired fail**（s1-s8 已通）
- 主干现有 30+ 个 R0.5/R1/R3-A/R2-A0/R2-A.0~A.10 commit **可安全 push**，对线上无影响
