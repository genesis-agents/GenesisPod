...
- backend/src/modules/core/settings/settings.service.ts - AES-256-CBC 加密逻辑
- backend/src/modules/core/admin/admin.service.ts - maskApiKey, createAIModel, getAIModelApiKey
- backend/src/modules/core/admin/admin.controller.ts - API 端点定义
- backend/src/modules/core/admin/admin.module.ts - 引用了不存在的 SecretsModule (行 13)
- backend/src/modules/core/secrets/ - 目录不存在（导致编译错误）
...
文件: backend/src/modules/core/settings/settings.service.ts
...
backend/src/modules/core/secrets/
...
1. 创建 backend/src/modules/core/secrets/ 目录
...
| 文件                                                   | 说明       |
| ------------------------------------------------------ | ---------- |
| backend/src/modules/core/secrets/secrets.module.ts     | 模块定义   |
| backend/src/modules/core/secrets/secrets.service.ts    | 核心服务   |
| backend/src/modules/core/secrets/secrets.controller.ts | API 控制器 |
| backend/src/modules/core/secrets/dto/\*.ts             | DTOs       |
...
| backend/src/modules/core/admin/admin.module.ts                | 修复导入            |
