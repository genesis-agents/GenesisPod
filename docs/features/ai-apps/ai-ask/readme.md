...
AI Ask 是 DeepDive Engine 的智能问答模块，提供类似 ChatGPT 的对话体验，同时支持知识库检索增强（RAG）和工具调用能力。
...
- **项目上下文**: 自动识别 DeepDive Engine 相关问题并注入项目知识
- **自动标题**: 根据首条消息自动生成会话标题
...
{
  "content": "你好，请介绍一下 DeepDive Engine",
...
当用户提问包含以下关键词时，自动注入 DeepDive Engine 项目知识：
